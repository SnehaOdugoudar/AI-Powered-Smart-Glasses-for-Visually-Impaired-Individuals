...
engine.setProperty('rate', 180)  # Default ~200, lower is slower, higher is faster
...
# Define minimum bounding box area for announcement
MIN_BBOX_AREA = 5000  
LARGE_BBOX_AREA = 15000  # Threshold for "very close" objects (priority alert)
...
while cap.isOpened():
    ...
    for index, row in results.pandas().xyxy[0].iterrows():
        ...
        if bbox_area > MIN_BBOX_AREA:  # Only consider close objects
            ...
            # Set priority alert for very close objects
            if bbox_area > LARGE_BBOX_AREA:
                ...
                engine.setProperty('volume', 0.7)  # Normal volume
